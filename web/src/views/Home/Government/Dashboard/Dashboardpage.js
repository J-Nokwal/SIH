...
const Dashboardpage = () => {
  ...
  const Incomes = ["ten", "twenty", "thrity", "fourty", "fifty"];
  const Grades = ["ten", "twenty", "thrity", "fourty", "fifty"];
  const edlevel = ["ten", "twenty", "thrity", "fourty", "fifty"];
  const Categories = ["ten", "twenty", "thrity", "fourty", "fifty"];
  const Streams = ["ten", "twenty", "thrity", "fourty", "fifty"];
            ...
            <div className="bg-hcolor w-520 h-262">
              <div className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-3   ">
                  ...
                  <div className="mt-6">
                    <div className="text-21 font-bold">Cities</div>
                  </div>
                  <div className="mt-6">
                    <div className="text-21 font-bold">XXXXX</div>
                  </div>
